...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,  # প্রতি পেজে কয়টি প্রোডাক্ট দেখাবে তা এখানে সেট করবেন
}
...
# JWT Token Settings
SIMPLE_JWT = {
    # Access Token এর মেয়াদ (যেমন: ৫ মিনিট থেকে বাড়িয়ে ২ ঘণ্টা করা হলো)
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=10),
    
    # Refresh Token এর মেয়াদ (যেমন: ১ দিন থেকে বাড়িয়ে ৭ দিন করা হলো)
...
#     'TITLE': 'PharmaSys API Project',
#     'DESCRIPTION': 'Complete E-commerce Pharmacy Backend API',
#     'VERSION': '1.0.0',
